    ...
    return (
      <div>
        ...
        <div className="mt-8 rounded-lg bg-amber-50 border border-amber-200 p-4 text-xs text-amber-800 print:mt-4">
          ...
          <p>
            This business case is generated by AI based on AI Compass EU assessment data.
            Figures are estimates and should be validated with vendor quotes and internal financial analysis.
            This document does not constitute legal, financial, or procurement advice.
          </p>
        </div>
      </div>
    );
