...
const tiers = [
  {
    ...
    highlighted: false,
    features: [
      { text: "5 most-used AI systems with full detail", included: true },
      { text: "AI compliance chatbot — 10 questions per day", included: true },
      { text: "Full newsfeed + reports & white papers", included: true },
      { text: "Compare free-tier AI systems side-by-side", included: true },
      { text: "Weekly newsletter", included: true },
      { text: "All 60+ AI systems with full assessments", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Multiple team seats with SSO (tailored to your needs)", included: true },
