...
const serviceTitleKeys = [
  "pricing.service1Title",
  "pricing.service2Title",
  "pricing.service3Title",
];

const serviceDescKeys = [
  "pricing.service1Desc",
  "pricing.service2Desc",
  "pricing.service3Desc",
];
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center mb-12">
              <p className="text-sm font-semibold text-[#003399] tracking-wide uppercase">
                {t("pricing.advisoryBadge")}
              </p>
              <h2 className="mt-2 text-2xl font-bold text-[#0d1b3e] sm:text-3xl">
                {t("pricing.advisoryTitle")}
              </h2>
              <p className="mt-3 text-gray-600">
                {t("pricing.advisorySubtitle")}
              </p>
            </div>
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              {serviceIcons.map((icon, i) => (
                ...
                >
                  ...
                  <h3 className="mt-4 text-base font-bold text-[#0d1b3e]">{t(serviceTitleKeys[i])}</h3>
                  <p className="mt-2 text-sm text-gray-600">{t(serviceDescKeys[i])}</p>
                </div>
              ))}
            </div>
