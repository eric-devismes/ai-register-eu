...
async function getAccountContext(subscriberId: string | null, locale: string): Promise<string> {
  ...
  try {
    ...
    return [
      ...
      "- Refunds: If requested within 14 days of initial purchase, full refund available. Contact support@aicompass.eu.",
      "- Billing disputes: If charged incorrectly, contact support@aicompass.eu with billing details.",
      ...
      "- Technical issues: For platform bugs or access issues, contact support@aicompass.eu.",
      "",
      "RESPONSE RULES:",
      ...
      "- If the issue cannot be resolved via self-service, direct them to support@aicompass.eu.",
