  ...
  sections: [
    ...
    },
    {
      ...
      statements: [
        ...
        { reference: "Article 28(1)", statement: "The controller shall use only processors providing sufficient guarantees to implement appropriate technical and organisational measures so that processing meets GDPR requirements.", commentary: "When you engage an AI vendor, you are a controller and they are your processor. You must verify their compliance before signing. This means reviewing their DPA, security certifications, data handling practices, and subprocessor chain \u2014 exactly what VendorScope assessments evaluate.", sortOrder: 2 },
